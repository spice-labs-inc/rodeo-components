 ...
 * in the form <code>--component &lt;component-name&gt; parameter+<code>. Goat rodeo will accumulate all arguments that are
 * destined for components and after all other arguments have been processed, goat rodeo will call registered <code>RodeoArgumentListener<code>
 ...
 * <p>
 * <ul>
 * <li>Goat rodeo will call <code>begin</code> and the component will return a {@link io.spicelabs.rodeocomponents.APIS.arguments.RodeoArgumentMemento}.</li>
 * <li>Goat rodeo will call <code>receiveArgument</code> for each instance of <code>--component name</code> and the component will return a {@link io.spicelabs.rodeocomponents.APIS.arguments.RodeoArgumentResult}.</li>
 * <li>Goat rodeo will call <code>end</code> after all the arguments have been handled.
 * </ul>
 * <p>
 * Goat rodeo doesn't presume that there is any meaning to the arguments and parameters passed to a <code>RodeoArgumentListener</code>. It
 ...
 * <code>--component watcher verbose --component watcher verbose</code> to indicate more verbosity or <code>--component watcher verbosity 5</code>,
 ...
 * information in the memento and then when <code>end</code> is called, it can finish configuration and report errors, if any.
 * <p>
...
public interface RodeoArgumentListener {
  /**
   * Called by goat rodeo, <code>begin</code> is used to indicate that argument processing for the component is going to begin.
   * @return a memento that will be passed back to the component.
   */
  RodeoArgumentMemento begin();
  /**
   * Called by goat rodeo, <code>receiveArgument</code> will be called for each argument destined for a component. The component
   ...
   * @param memento the last memento that was returned from either a call to <code>begin</code> or the last call to <code>receiveArgument</code>
  ...
  /**
   * Called by goat rodeo, <code>end</code> will be called after the last argument for this component has been handled.
